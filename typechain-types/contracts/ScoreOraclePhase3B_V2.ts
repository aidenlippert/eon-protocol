...
export declare namespace ScoreOraclePhase3B_V2 {
...
export interface ScoreOraclePhase3B_V2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "MIN_COLLATERAL_FOR_DIVERSITY"
      | "TIER_GOLD"
      | "TIER_PLATINUM"
      | "TIER_SILVER"
      | "addChainSelector"
  ...
  encodeFunctionData(
    functionFragment: "MIN_COLLATERAL_FOR_DIVERSITY",
    values?: undefined
  ): string;
...
export interface ScoreOraclePhase3B_V2 extends BaseContract {
  connect(runner?: ContractRunner | null): ScoreOraclePhase3B_V2;
  waitForDeployment(): Promise<this>;

  interface: ScoreOraclePhase3B_V2Interface;
  ...
  MIN_COLLATERAL_FOR_DIVERSITY: TypedContractMethod<[], [bigint], "view">;
  ...
  computeScore: TypedContractMethod<
    [subject: AddressLike],
    [ScoreOraclePhase3B_V2.ScoreBreakdownStructOutput],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "MIN_COLLATERAL_FOR_DIVERSITY"
