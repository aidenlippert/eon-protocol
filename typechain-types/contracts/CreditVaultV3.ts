...
export interface CreditVaultV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "GRACE_BRONZE"
      | "GRACE_GOLD"
...
export interface CreditVaultV3 extends BaseContract {
  connect(runner?: ContractRunner | null): CreditVaultV3;
  waitForDeployment(): Promise<this>;

  interface: CreditVaultV3Interface;
