...
export declare namespace CreditVaultV2 {
  export type VaultLoanDataStruct = {
  ...
  export type VaultLoanDataStructOutput = [
...
export interface CreditVaultV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "GRACE_BRONZE"
      | "GRACE_GOLD"
  ...
  encodeFunctionData(
    functionFragment: "getVaultLoanData",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface CreditVaultV2 extends BaseContract {
  connect(runner?: ContractRunner | null): CreditVaultV2;
  waitForDeployment(): Promise<this>;

  interface: CreditVaultV2Interface;
  ...
  getVaultLoanData: TypedContractMethod<
    [loanId: BigNumberish],
    [CreditVaultV2.VaultLoanDataStructOutput],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "getVaultLoanData"
  ): TypedContractMethod<
    [loanId: BigNumberish],
    [CreditVaultV2.VaultLoanDataStructOutput],
    "view"
