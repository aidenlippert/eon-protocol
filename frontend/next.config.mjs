        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://verify.didit.me https://verification.didit.me https://*.didit.me https://*.arbitrum.io https://*.alchemy.com https://*.walletconnect.com wss://*.walletconnect.com",
